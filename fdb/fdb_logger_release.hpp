...
extern template class Log<4,stdioname,FILE>;
typedef Log<4,stdioname,FILE> StdioSink;

// The File log Sink:
extern const char mainlogfilename[];
extern template class Log<4,mainlogfilename,FILE>;
typedef Log<4,mainlogfilename,FILE> MainLogFileSink;
